...
// Final nav: Home / Signals / World Lore / Settings — all four pages now exist
// (secondary-UI overhaul). The dispatch sections and About remain reachable from
// the home crew cards and the Signals feed.
const NAV_LINKS = [
  { href: '/', label: 'HOME' },
